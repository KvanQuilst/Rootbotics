...
private
  ...
  Meeple_Supply : Integer range 0..MEEPLE_MAX := 14;
  Roost_Supply  : Integer range 0..ROOST_MAX  := 6;

  Meeples : array (Integer range 1..12) of Natural;
  Roosts  : array (Integer range 1..12) of Boolean;
